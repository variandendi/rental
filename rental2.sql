...
--
-- Host: 127.0.0.1
-- Generation Time: 08 Apr 2019 pada 13.53
...
CREATE TABLE `dt_album` (
  ...
  `id_user_album` int(11) DEFAULT NULL,
  `author_album` varchar(60) DEFAULT NULL,
  `jumlah_album` int(11) DEFAULT '0',
  `cover_album` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `dt_album`
--

INSERT INTO `dt_album` (`id_album`, `nama_album`, `tanggal_album`, `id_user_album`, `author_album`, `jumlah_album`, `cover_album`) VALUES
(5, 'Foto', '2018-05-12 14:43:14', 2, 'Achmad Fadli Aditama', 2, 'b670c895bf0a413da6011d08e1155165.jpg');

-- --------------------------------------------------------

--
-- Struktur dari tabel `dt_berita`
--

CREATE TABLE `dt_berita` (
  `id_berita` int(11) NOT NULL,
  `judul_berita` varchar(200) DEFAULT NULL,
  `isi_berita` text,
  `tanggal_berita` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `id_kategori_berita` int(11) NOT NULL,
  `nama_kategori_berita` varchar(30) DEFAULT NULL,
  `views_berita` int(11) NOT NULL,
  `gambar_berita` varchar(50) DEFAULT NULL,
  `id_user_berita` int(11) NOT NULL,
  `author_berita` varchar(40) DEFAULT NULL,
  `image_slider_berita` int(2) NOT NULL,
  `slug_berita` varchar(250) DEFAULT NULL,
  `rating_berita` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `dt_berita`
--

INSERT INTO `dt_berita` (`id_berita`, `judul_berita`, `isi_berita`, `tanggal_berita`, `id_kategori_berita`, `nama_kategori_berita`, `views_berita`, `gambar_berita`, `id_user_berita`, `author_berita`, `image_slider_berita`, `slug_berita`, `rating_berita`) VALUES
(1, 'Mobil', 'qgwjqhsjhwqjwhgedjawhkudhawukhdukawukdhukehd w djhwdwn denw ewewq ewq e w qe qw eqw eqw eqw e wqe qw eqw ew eq we qwe qw ewq ewq e wq e w q eqw e qw eqw eqw eqw eqw e  wq e wq eqwheuihqwe ', '2019-04-08 07:21:52', 1, 'tes1', 1, 'a2413f94e5cc797810454fa09913783e.jpg', 1, 'Varian Dendisono', 0, 'mobil.html', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `dt_gallery`
--

CREATE TABLE `dt_gallery` (
  `id_gallery` int(11) NOT NULL,
  `judul_gallery` varchar(60) DEFAULT NULL,
  `tanggal_gallery` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `gambar_gallery` varchar(40) DEFAULT NULL,
  `id_album_gallery` int(11) DEFAULT NULL,
  `id_user_gallery` int(11) DEFAULT NULL,
  `author_gallery` varchar(60) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `dt_gallery`
--

INSERT INTO `dt_gallery` (`id_gallery`, `judul_gallery`, `tanggal_gallery`, `gambar_gallery`, `id_album_gallery`, `id_user_gallery`, `author_gallery`) VALUES
(23, 'Mobil', '2019-04-08 05:03:16', '9d564b67650be83b547f1c12c3d38c8e.jpg', 5, 1, 'Admin'),
(24, 'anjing', '2019-04-08 07:59:36', '70f6939f2436c6047869eb6a230eed56.jpg', 5, 1, 'Varian Dendisono');

-- --------------------------------------------------------

--
-- Struktur dari tabel `dt_kategori`
--
...
--
-- Dumping data untuk tabel `dt_kategori`
--

INSERT INTO `dt_kategori` (`id_kategori`, `nama_kategori`, `tanggal_kategori`) VALUES
(1, 'tes1', '2019-04-08 07:13:03'),
(2, 'tes2', '2019-04-08 07:13:15');

-- --------------------------------------------------------

--
-- Struktur dari tabel `dt_komentar`
--

CREATE TABLE `dt_komentar` (
  `id_komentar` int(11) NOT NULL,
  `nama_komentar` varchar(30) DEFAULT NULL,
  `email_komentar` varchar(50) DEFAULT NULL,
  `web_komentar` varchar(100) DEFAULT NULL,
  `isi_komentar` varchar(120) DEFAULT NULL,
  `tanggal_komentar` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status_komentar` int(2) NOT NULL,
  `id_komentar_berita` int(11) DEFAULT NULL,
  `parent_komentar` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `dt_pesan` (
  `id_pesan` int(11) NOT NULL,
  `nama_pesan` varchar(40) DEFAULT NULL,
  `email_pesan` varchar(60) DEFAULT NULL,
  `subjek_pesan` varchar(40) DEFAULT NULL,
  `kontak_pesan` varchar(20) DEFAULT NULL,
  `pesan` text,
  `tanggal_pesan` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status_pesan` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `dt_pesan`
--

INSERT INTO `dt_pesan` (`id_pesan`, `nama_pesan`, `email_pesan`, `subjek_pesan`, `kontak_pesan`, `pesan`, `tanggal_pesan`, `status_pesan`) VALUES
(1, 'ADMIN', 'tes@gmail.com', 'tes', NULL, 'tes', '2019-04-08 03:27:06', 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `dt_rating`
--

CREATE TABLE `dt_rating` (
  `id_rating` int(11) NOT NULL,
  `tanggal_rating` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `ip_rating` varchar(40) DEFAULT NULL,
  `point_rating` int(11) DEFAULT NULL,
  `id_rating_berita` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `dt_user` (
  ...
  `levelakses` varchar(3) DEFAULT NULL,
...
INSERT INTO `dt_user` (`id`, `nama`, `username`, `password`, `status`, `levelakses`, `register`, `foto`, `jenkel`, `email`, `nohp`) VALUES
(1, 'Varian Dendisono', 'variandendi', '827ccb0eea8a706c4c34a16891f84e7b', 1, '1', '2019-04-08 06:28:49', NULL, 'L', 'variandendisono@gmail.com', '081381234891');

-- --------------------------------------------------------

--
-- Struktur dari tabel `dt_view`
--

CREATE TABLE `dt_view` (
  `id_view` int(11) NOT NULL,
  `tanggal_view` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `ip_view` varchar(40) DEFAULT NULL,
  `id_view_berita` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `dt_view`
--

INSERT INTO `dt_view` (`id_view`, `tanggal_view`, `ip_view`, `id_view_berita`) VALUES
(2, '2018-05-12 12:29:53', '::1', 0),
(3, '2018-05-12 23:05:49', '::1', 1),
(4, '2018-05-13 00:49:57', '::1', 2),
(5, '2018-05-13 00:55:25', '::1', 5),
(6, '2018-05-13 00:55:35', '::1', 0),
(7, '2019-04-08 02:44:56', '::1', 0),
(8, '2019-04-08 02:45:03', '::1', 5),
(9, '2019-04-08 07:58:48', '::1', 1);
...
(1, 'Hits', '2016-09-06 05:49:04'),
(2, 'Teknologi', '2016-09-06 05:50:01'),
(3, 'Art & Culture', '2016-09-06 05:59:39');
...
(2, 'Achmad Fadli Aditama', 'Ga Boleh nyerah tapi Boleh ngegad :v', 'L', 'fadli', '42390d9e2df6f4a8cb162d6743cb69a7', 'Saya ganteng', 'profadlibae@gmail.com', '082280729085', 'facebook.com/profadlibae', NULL, NULL, NULL, 1, '1', '2018-05-11 17:00:00', 'fadli.jpg'),
(3, 'Admin', NULL, 'L', 'admin', 'admin', NULL, 'tensei99@gmail.com', '087891123213', NULL, NULL, NULL, NULL, 1, '1', '2018-05-12 14:24:36', '850ffd9a9d6aef2171212d1cfb8f24c7.png'),
(4, 'Author', NULL, 'L', 'author', 'e10adc3949ba59abbe56e057f20f883e', NULL, 'edotensei@gmail.com', '0812345678', NULL, NULL, NULL, NULL, 1, '2', '2018-05-12 14:26:26', '18f09f1408498e80f8b74ab6c134734b.jpg'),
(5, 'fadli', NULL, NULL, 'fadli', 'fadli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2018-12-17 03:08:51', NULL);
...
(946, '2018-05-12 07:43:38', '::1', 'Chrome'),
(947, '2018-05-12 17:08:26', '::1', 'Chrome'),
(948, '2018-12-17 02:37:11', '::1', 'Chrome'),
(949, '2018-12-18 01:10:34', '::1', 'Chrome'),
(950, '2018-12-19 01:03:36', '::1', 'Chrome'),
(951, '2018-12-21 03:08:12', '::1', 'Chrome'),
(952, '2019-04-06 14:31:46', '::1', 'Chrome'),
(953, '2019-04-06 17:02:42', '::1', 'Chrome'),
(954, '2019-04-08 02:30:23', '::1', 'Spartan');
...
(4, 'Mobil Camaro', NULL, '2017-07-20 07:25:06', 'A Fadli Aditama', 'camaro1.jpg'),
(6, 'Mobil BMW', NULL, '2017-08-29 13:31:55', 'A Fadli Aditama', 'bmw.png'),
(7, 'Mobil Srt', NULL, '2017-08-29 13:33:57', 'A Fadli Aditama', 'srt.jpg');
...
(55, '2018-05-12 09:40:55', '::1', 31),
(56, '2018-05-12 09:40:56', '::1', 0),
(57, '2018-05-12 12:01:25', '::1', 30),
(58, '2018-05-12 12:48:46', '::1', 27),
(59, '2018-05-12 14:38:37', '::1', 29),
(60, '2019-04-06 14:33:17', '::1', 31),
(61, '2019-04-06 14:33:19', '::1', 0);
...
(29, 'Supaya Tahan Lama, Seniman Mesir Buat Karya dengan Bakar Tembakau', '<p>Bila tembakau di Indonesia sangat populer sebagai bahan rokok, maka seorang seniman Mesir memperlakukannya berbeda. Dalam sebuah studio kecil yang dipenuhi oleh kotak rokok, Abdulrahman Al Habrouk membuat karyanya dari tembakau. Seperti yang dirilis oleh reuters.com, Rabu, (16/8/2017).</p>\r\n\r\n<p>Disusun menyerupai sosok Jhonny Depp, Abdulrahman membakar tembakau yang sudah disusunnya di atas kertas. Hasilnya, jejak pembakaran tembakau yang ada akan meninggalkan jejak di kertas putih. Tentunya semua tembakau ini ia peroleh setelah membelah rokok dan menyusunnya sehingga berbentuk seperti sosok tokoh terkenal.</p>\r\n\r\n<p>Berusia 23 tahun, Abdulrahman selalu menggunakan bahan-bahan yang tidak biasa dalam beberapa tahun terakhir. Studionya di kota Alexsandria, selalu dipenuhi oleh eksperimen karya dengan kopi, garam, hingga pasir. Hingga akhirnya ia menemukan tembakau, sebagai bahan gambar yang lebih tahan lama.</p>\r\n\r\n<p>Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel.</p>\r\n\r\n<p>Abdulrahman menceritakan, ide ini muncul karena gagasannya yang ingin membuat karya hidup lebih lama. Ia juga ingin menghasilkan sebuah karya yang baik dari bahan-bahan yang dianggap berbahaya. Apakah Anda ingin mencoba menggunakan tembakau menjadi karya?</p>\r\n\r\n<p>Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel.</p>\r\n', '2017-08-16 02:36:39', 2, 'Art & Culture', 5, 'berita3.jpg', 1, 'Akbar Muhibar', 0, 'supaya-tahan-lama-seniman-mesir-buat-karya-dengan-bakar-tembakau.html', 5),
(30, 'Kampung di Depok Viral, Gambar 3D di Jalanan Jadi Objek Wisata', '<p><em>Apa yang dilakukan pemuda Karang Taruna di Jalan Danau Tonado RW 3 Kelurahan Sukma Jaya Depok, Jawa Barat, ini bisa jadi inspirasi untuk menarik minat warga datang, sekaligus menjadi potensi sebagai kampung wisata.</em></p>\r\n\r\n<p>Mereka ternyata punya cara unik dengan menuangkan ide membuat gambar tiga dimensi. Beruntung, saat itu memang di lingkungan kampung sedang diadakan perbaikan jalan.</p>\r\n\r\n<p>Anak-anak muda kreatif yang mengambil ide gambar tiga dimensi dari Google ini akhirnya tebersit untuk membuat sesuatu yang menarik bagi kampungnya.</p>\r\n\r\n<p>Meskipun tidak memiliki dasar-dasar menggambar, dengan bersumber dari Google, pemuda karang taruna tak patah arang. Mereka mencoba salah satu gambar paling mudah terlebih dahulu, kemudian berkembang menjadi gambar-gambar yang lebih kompleks lagi.</p>\r\n\r\n<p>Ada beberapa gambar yang memang terlihat seperti sebuah ilusi tiga dimensi, di antaranya gambar rubik, sumur bata merah, jurang, hingga permadani terbang. Salah satu gambar yang pertama kali diterapkan adalah zebra cross tiga dimensi yang seolah-olah melayang.</p>\r\n\r\n<p>Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel. Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel Ini adalah sampel artikel.</p>\r\n\r\n<p>Melihat respons positif dari warga, akhirnya pemuda karang taruna melanjutkan proyek mereka menggambar jalanan dengan gambar tiga dimensi. Beberapa warga bahkan ada yang menyumbang cat demi terwujudnya gambar tiga dimensi yang menarik dan unik.</p>\r\n\r\n<p>Ide untuk membuat gambar tiga dimensi ini pun menjadi perbincangan viral di media sosial. Karena makin populer, beberapa pemuda bahkan berinisiatif membuka kotak amal untuk pengunjung agar bisa membantu proyek-proyek mereka selanjutnya. Mereka juga berharap ada sponsor yang membantu proyek kampung tiga dimensi di Depok ini.</p>\r\n', '2017-10-27 02:46:11', 2, 'Hits', 12, 'berita2.jpg', 1, 'Liputan6.com', 0, 'kampung-di-depok-viral-gambar-3d-di-jalanan-jadi-objek-wisata.html', 4),
(31, 'Google Mendadak Hapus Fitur View Images, Apa Alasannya?', '<p>Sering melihat atau menyimpan gambar lewat Google? Mungkin sekarang kamu tak akan lagi bisa melakukannya langsung.\r\n\r\nPasalnya, Google baru saja mengumumkan telah menghapus fiturnya yang bernama \'View Images\' ini.\r\n\r\nMelalui Twitter-nya, Google mencuit kalau mereka memang telah menghapus fitur tersebut langsung dari laman pencariannya.<br />\r\n<!--[if !supportLineBreakNewLine]--><br />\r\n<!--[endif]-->\"Pada hari ini, kami telah meluncurkan sejumlah perubahan pada Google Images untuk membantu menghubungkan pengguna dengan situs-situs yang mereka ingin kunjungi,\" tulis Google.\r\n\r\n\"Perubahan ini termasuk fitur View Images yang telah kami hapus. Namun, tombol mengunjungi laman yang berkaitan masih ada. Jadi pengguna bisa langsung melihat gambar dalam situs yang mereka kunjungi,\" tambahnya menjelaskan.</p>\r\n\r\n<p>Untuk informasi, fitur View Image yang hadir berupa tombol ini memang membantu pengguna yang sedang mencari gambar untuk melihat gambar secara keseluruhan dalam format aslinya, dan bisa disimpan langsung tanpa harus lebih dulu mengunjungi situs yang memuat gambar tersebut.</p>\r\n\r\n<p>Menurut informasi yang dilansir The Verge, Senin (19/2/2018), upaya ini merupakan langkah Google untuk melindungi hak cipta fotografer serta tanggapan terhadap kritik dari para fotografer dan perusahaan penyedia foto seperti Getty Images.</p>\r\n\r\n<p>&nbsp;</p>\r\n', '2018-02-19 02:51:02', 2, 'Teknologi', 12, 'berita1.jpg', 1, 'Jeko I. R.', 0, 'google-mendadak-hapus-fitur-view-images-apa-alasannya.html', 3);
...
--
-- Indexes for table `dt_album`
--
ALTER TABLE `dt_album`
  ADD PRIMARY KEY (`id_album`),
  ADD KEY `album_pengguna_id` (`id_user_album`);

--
-- Indexes for table `dt_berita`
--
ALTER TABLE `dt_berita`
...
ALTER TABLE `dt_gallery`
  ...
  ADD KEY `galeri_album_id` (`id_album_gallery`),
  ADD KEY `galeri_pengguna_id` (`id_user_gallery`);
...
--
-- Indexes for table `dt_pesan`
--
ALTER TABLE `dt_pesan`
  ADD PRIMARY KEY (`id_pesan`);

--
-- Indexes for table `dt_rating`
--
ALTER TABLE `dt_rating`
...
--
-- AUTO_INCREMENT for table `dt_album`
--
ALTER TABLE `dt_album`
  MODIFY `id_album` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `dt_berita`
--
ALTER TABLE `dt_berita`
...
--
-- AUTO_INCREMENT for table `dt_rating`
--
ALTER TABLE `dt_rating`
...
--
-- AUTO_INCREMENT for table `dt_view`
--
ALTER TABLE `dt_view`
  MODIFY `id_view` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tbl_post_views`
  MODIFY `views_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
